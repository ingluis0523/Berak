  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-gray-200 bg-white px-3.5 sm:px-5">
      <button
        type="button"
        onClick={onMenuClick}
        className="md:hidden p-2 -ml-1 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors shrink-0"
      ...
      {title && (
        <h1 className="text-base font-semibold text-gray-800 mr-auto truncate">
          {title}
        </h1>
      )}
